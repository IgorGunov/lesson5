package ru.mirea.gunovigor.camera;
...
import ru.mirea.gunovigor.camera.databinding.ActivityMainBinding;
...
//// генерирование пути к файлу на основе authorities
//        String authorities = getApplicationContext().getPackageName() + ".fileprovider";
//        Object imageUri = FileProvider.getUriForFile(MainActivity.this, authorities, photoFile);
